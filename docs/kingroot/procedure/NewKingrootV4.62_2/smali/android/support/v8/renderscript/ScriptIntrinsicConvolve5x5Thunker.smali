...
.method public static create(Landroid/support/v8/renderscript/RenderScript;Landroid/support/v8/renderscript/Element;)Landroid/support/v8/renderscript/ScriptIntrinsicConvolve5x5Thunker;
    ...
    .line 37
    new-instance v1, Landroid/support/v8/renderscript/ScriptIntrinsicConvolve5x5Thunker;

    const/4 v2, 0x0

    invoke-direct {v1, v2, p0}, Landroid/support/v8/renderscript/ScriptIntrinsicConvolve5x5Thunker;-><init>(ILandroid/support/v8/renderscript/RenderScript;)V
    ...
    invoke-static {v0, v2}, Landroid/renderscript/ScriptIntrinsicConvolve5x5;->create(Landroid/renderscript/RenderScript;Landroid/renderscript/Element;)Landroid/renderscript/ScriptIntrinsicConvolve5x5;

    move-result-object v0

    iput-object v0, v1, Landroid/support/v8/renderscript/ScriptIntrinsicConvolve5x5Thunker;->mN:Landroid/renderscript/ScriptIntrinsicConvolve5x5;
    :try_end_0
...
.method public forEach(Landroid/support/v8/renderscript/Allocation;)V
    ...
    invoke-virtual {v0, v1}, Landroid/renderscript/ScriptIntrinsicConvolve5x5;->forEach(Landroid/renderscript/Allocation;)V
    :try_end_0
    .catch Landroid/renderscript/RSRuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getFieldID_Input()Landroid/support/v8/renderscript/Script$FieldID;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v8/renderscript/ScriptIntrinsicConvolve5x5Thunker;->createFieldID(ILandroid/support/v8/renderscript/Element;)Landroid/support/v8/renderscript/Script$FieldID;
...
.method public getKernelID()Landroid/support/v8/renderscript/Script$KernelID;
    ...
    invoke-virtual {p0, v0, v1, v2, v2}, Landroid/support/v8/renderscript/ScriptIntrinsicConvolve5x5Thunker;->createKernelID(IILandroid/support/v8/renderscript/Element;Landroid/support/v8/renderscript/Element;)Landroid/support/v8/renderscript/Script$KernelID;
...
.method public setInput(Landroid/support/v8/renderscript/Allocation;)V
    ...
    invoke-virtual {v0, v1}, Landroid/renderscript/ScriptIntrinsicConvolve5x5;->setInput(Landroid/renderscript/Allocation;)V
    :try_end_0
    .catch Landroid/renderscript/RSRuntimeException; {:try_start_0 .. :try_end_0} :catch_0
